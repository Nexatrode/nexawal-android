...
/**
 * Isolated Compose semantics tests — no wallet / MainActivity required.
 * Still needs a device/emulator (`connectedDebugAndroidTest`).
 */
...
class AccessibilityHelpersTest {
    ...
    fun syncProgress_exposesProgressSemantics() {
        ...
        val nodes = composeRule.onNodeWithTag(A11yTags.SYNC_PROGRESS)
            .fetchSemanticsNode()
        assertTrue(
